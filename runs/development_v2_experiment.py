...
def llm(env,signal,tag):
 ...
 user={'rules':rules,'observations':env.observations,'history':env.history,'controller':{'recommendation':signal['recommendation'],'scores':signal['scores']}}
...
if __name__=='__main__':
 ...
 if args.command=='graphs':print(make_graphs())
  ...
  is_test=args.command=='test';tag='test' if is_test else 'validation_v2';path=ROOT/f'runs/{tag}_episodes.jsonl'
